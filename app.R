#setwd("/Users/vikassaini/projects/DataBot")
...
ui <- bootstrapPage(useShinyjs(),
                    ...
                    dashboardPage(skin = 'red', title = "DataBot",
                                  dashboardHeader(title = HTML(paste(icon('cubes'),'DataBot'))
                                  ),
                                  dashboardSidebar(
                                    sidebarMenu(
                                      id = "tabs",
                                    ...
                                    absolutePanel(
                                      ...
                                      width='100%',
                                      height='auto',
                                      a(icon('github fa-2x'),href='https://github.com/saini3108/DataBot',target='_blank')
                                    )
                                  ),
                                  dashboardBody(
                                    tabItems(

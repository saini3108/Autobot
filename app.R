#setwd("/Users/vikassaini/projects/Autobot")
...
ui <- bootstrapPage(useShinyjs(),
                    ...
                    dashboardPage(skin = 'red', title = "AutoBot",
                                  dashboardHeader(title = HTML(paste(icon('cubes'),'AutoBot'))
                                  ),
                                  dashboardSidebar(
                                    sidebarMenu(
                                      id = "tabs",
                                    ...
                                    absolutePanel(
                                      ...
                                      width='100%',
                                      height='auto',
                                      a(icon('github fa-2x'),href='https://github.com/saini3108/Autobot',target='_blank')
                                    )
                                  ),
                                  dashboardBody(
                                    tabItems(
